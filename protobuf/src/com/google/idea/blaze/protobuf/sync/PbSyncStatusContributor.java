...
class PbSyncStatusContributor implements SyncStatusContributor {
  ...
  public boolean handlesFile(BlazeProjectData projectData, VirtualFile file) {
    return projectData.getWorkspaceLanguageSettings().isLanguageActive(LanguageClass.PROTO)
        && file.getName().endsWith(".proto");
  }
}
