...
public class PbPrefetchFileSource implements PrefetchFileSource, OutputsProvider {

  @Override
  public boolean isActive(WorkspaceLanguageSettings languageSettings) {
    return languageSettings.isLanguageActive(LanguageClass.PROTO);
  }

  @Override
  public Collection<ArtifactLocation> selectAllRelevantOutputs(TargetIdeInfo target) {
    return target.getProtoIdeInfo() != null ? target.getProtoIdeInfo().getSources() : ImmutableList.of();
  }
  ...
  public void addFilesToPrefetch(
      ...
      Set<File> files) {
    files.addAll(
        BlazePbAdditionalLibraryRootsProvider.getLibraryFiles(
